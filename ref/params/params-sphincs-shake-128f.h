...
#define LEAF_NUM (1<<SPX_TREE_HEIGHT)
...
/* Resulting SPX sizes. */
// #define SPX_BYTES ((SPX_N + SPX_FORS_BYTES + SPX_D * SPX_WOTS_BYTES +SPX_FULL_HEIGHT * SPX_N+(SPX_D*COUNTER_SIZE))+COUNTER_SIZE)
#define SPX_BYTES (SPX_N + SPX_D * SPX_WOTS_BYTES + SPX_FULL_HEIGHT * SPX_N + (SPX_D * COUNTER_SIZE))
#define AUTH_BYTES (SPX_D * SPX_WOTS_BYTES +SPX_FULL_HEIGHT * SPX_N+(SPX_D*COUNTER_SIZE))
